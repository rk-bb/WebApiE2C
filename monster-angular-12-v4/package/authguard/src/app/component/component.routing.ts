...
export const ComponentsRoutes: Routes = [
	{
		...
		children: [
			...
			{
				path: 'mots-cles-list',
				component:  MotsClesListComponent,
				data: {
			...
			{
				path: 'motscles/mots-cles',
				component:  MotsClesComponent,
				data: {
					title: 'Ajouter mot clés',
				
				}
			},
			{
				path: 'competences/competences-list',
